higiKioskControllers.directive("loadingModal", ['$rootScope', '$timeout', 'HigiKioskStorageService', 'HigiKioskUtilitiesService', function($rootScope, $timeout, HigiKioskStorageService, HigiKioskUtilitiesService) {
        return {
            restrict : 'E',
            templateUrl: 'components/modal/page-loading.html',
            scope : false,
