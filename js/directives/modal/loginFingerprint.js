        ...
        controller: function ($scope) {
            ...
            if (!$rootScope.fingerprintTrueorFalse) {
                ...
                $scope.loginModal.emailOrMobileOrAadhaarPatternCheck = function (field) {
                    ...
                    else if (str.length == 12 && isNaN(str) == false && !specialCharacterPattern.test(str)) {
                    ...
                    else if (str.length == 10 && isNaN(str) == false && !specialCharacterPattern.test(str)) {
                            ...
                            HigiApiService.qLoginAsync($scope.loginModal.fields[0].text, $scope.loginModal.fields[1].text,
                                ...
                                console.log(resp);
                                    ...
                                    if (resp != null) {
                                        ...
                                        // $rootScope.UserInfo['abha_hip_link_alert_last_date'] = "1688472806000";//ABHA care context time integration
                                        HigiApiService.storeLoginUserRecord($rootScope.UserInfo.id, 'password', function(res){
               ...
               /* $scope.getPastKioskVitalData = function(resp) {
                            ...
                            $.ajax({
                                ...
                                success: function (html) {
                                    if(html == null || html == '' || html == undefined){
                                        ...
                                        $rootScope.UserInfo = html.User;
                                    }
                                    HigiApiService.storeLoginUserRecord($rootScope.UserInfo.id, 'fingerprint', function(res){
                                        console.log('storeLoginUserRecord', res)
                                        $rootScope.hideESanjeevaniBtn = false;
                                    }, function(err){
                                        console.log('storeLoginUserRecord', err);
                ...
                $scope.loginModal.guestUserLogin = function(){
                    if ($rootScope.IHLTeleConsultSelected == true || $rootScope.isGuestUserFlowDisable) {
                        return;
                    }
                    $scope.loginModal.loginEmailSection = false;
                    $scope.loginModal.quickOptionButton = false;
