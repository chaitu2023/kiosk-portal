higiKioskControllers.directive('registerModal',['$http', 'HigiKioskFlow', '$timeout', 'HigiApiService' ,'JkioskService', 'HigiKioskStorageService' ,'HigiKioskUserService' , '$route', '$sce', 'HigiKioskUtilitiesService', function($http, HigiKioskFlow, $timeout, HigiApiService, JkioskService, HigiKioskStorageService, HigiKioskUserService, $route, $sce, HigiKioskUtilitiesService) {
    ...
    return {
        ...
        controller :function($scope, $http, $rootScope){
            ...
            $scope.registerModal.init = function(){
                ...
                $scope.passValidConfirm = false;
                $scope.passConfirmText = '';
                //removeElement
                 ...
                 $scope.loggingg ="welcomeModals.login";
                 ...
                 $scope.validatelastname = "welcome.lastcharactervalidate";
                 $scope.ifYourEmployeeText = "welcomeModals.ifYourEmployeeText";

                 $scope.adha = "welcomeModals.enteradhar";
                 if ($rootScope.isRegFlowMobileMandatory)
		            $scope.mmbn = "welcomeModals.entermobMandatory";
                 else
            ...
            {
                // if ($rootScope.isRegFlowMobileMandatory && $rootScope.registerFlowFirstInput != 'email')
                ...
                if($scope.registerModal.fields[0].text.trim().length == 0){
                    ...
                    if ($scope.mobTextLengthSatisfied == true && $scope.adr1TextLengthSatisfied == true && $scope.adr2TextLengthSatisfied == true && $scope.adr3TextLengthSatisfied == true && $scope.emailText == true && (($scope.adr1FieldText.length == 0 && $scope.adr2FieldText.length == 0 && $scope.adr3FieldText.length == 0) || ($scope.adr1FieldText.length == 4 && $scope.adr2FieldText.length == 4 && $scope.adr3FieldText.length == 4)) ) {
                        ...
                        if ($rootScope.isRegFlowMobileMandatory && $rootScope.registerFlowFirstInput == 'mobile'){
                            if(($scope.adr1FieldText.length == 0 && $scope.adr2FieldText.length == 0 && $scope.adr3FieldText.length == 0) || ($scope.adr1FieldText.length == 4 && $scope.adr2FieldText.length == 4 && $scope.adr3FieldText.length == 4)){
                                $scope.registerModal.MobileSectionNextButtonClass = 'signup_modal_next_active_btn';
                            } else {
                                $scope.registerModal.MobileSectionNextButtonClass = '';        
                            }  
                                            ...
                                            success: function(html){
                                                ...
                                                if(finalString == "Email ID already exists"){
                                                   ...
                                                   // alert("ElseemailOrMobileExist"+finalString);
                                                    ...
                                                    console.log($rootScope.registerFlowFirstInput);
                                                    if ($rootScope.isRegFlowMobileMandatory && $rootScope.registerFlowFirstInput == 'mobile') {
                                                        $scope.mobTextLengthSatisfied = true;                                                    
                                                    } 
            ...
            $scope.registerModal.mobileNoPatternCheck = function(field){
                ...
                if(str.length == 10 && isNaN(str) == false && !specialCharacterPattern.test(str)) {
                    var emailIsThis = "";
            ...
            $scope.registerModal.aadharInputField1Check = function(field){
                ...
                $(".adr_no_validation_error_registration").css('display','none');
                ...
                if(str.length == 4 && isNaN(str) == false){
                    ...
                    if($scope.isRegFlowMobileMandatory == true && $rootScope.registerFlowFirstInput == 'mobile'){
                        $scope.mobTextLengthSatisfied = true;
                    }
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(html){
                                            ...
                                            if(finalString == "Aadhaar number already exists"){
                                                ...
                                                $scope.adr3TextLengthSatisfied = false;
                                                $(".adr_no_validation_loader").css('display','none');
                                                $(".adr_no_validation_error_registration").css('display','block');
                                                $(".adr_no_validation_srv_err").css('display','none');
                                                $scope.registerModal.MobileSectionNextButtonClass = '';
                                            }else if(finalString == ""){
...
/*            $scope.registerModal.passwordLengthCheck2 = function(field){
            ...
            $scope.registerModal.passwordLengthCheck = function(field){
                ...
                if(Boolean(str.match(/[a-z]/)) && Boolean(str.match(/\d/)) && Boolean(str.match(/[A-Z]/)) && str.length >= 8 && Boolean(str.match(/[@#$&%!~]/))){
                    $scope.passValidConfirm = true;
                    $('.signup_modal_new_password_hint').css({"color" : 'green'});
                }else{
                    $scope.passValidConfirm = false;
                    $('.signup_modal_new_password_hint').css({"color" : 'red'});
                }
                if($scope.passConfirmText.length > 0){
                    if($scope.passConfirmText == $scope.passValid){
...
*/
            $scope.registerModal.FirstNameValidation = function(field){
                ...
                if (specialCharacterPattern.test($("#firstname").val())) {
                    $scope.registerModal.firstLastNameSectionNextButtonClass = ' ';
                    return 0;
                }
                else if (specialCharacterPattern.test($("#lastname").val())) {
                    $scope.registerModal.firstLastNameSectionNextButtonClass = ' ';
                    return 0;
                }
            ...
            $scope.registerModal.LastNameValidation = function(field){               
                ...
                if (specialCharacterPattern.test($("#lastname").val())) {
                    $scope.registerModal.firstLastNameSectionNextButtonClass = ' ';
                    return 0;
                }
                else if (specialCharacterPattern.test($("#firstname").val())) {
                    $scope.registerModal.firstLastNameSectionNextButtonClass = ' ';
                    return 0;
                }
...
// First Name Validation and Last Name Validation done by Sumithra ends
            ...
            $scope.registerModal.toggleTermsAcceptance = function(){
                ...
                if(($scope.registerModal.termsAccepted == true)  && ($scope.registerModal.fields[5].text == $scope.registerModal.fields[6].text) && $scope.passValidConfirm){
                ...
                $http.get('docs/'+ $rootScope.termsAndPrivacyDocLang + '/' + appSettings['terms.filename'] + '.html').success(function(data){
                    ...
                    HigiApiService.fetch_terms_condition_from_config($rootScope.uniqueKioskId,
                        ...
                        function(resp) {
                          ...
                          console.log($scope.data_from_config)
                          $scope.registerModal.termsOfServicePpol = data + $scope.data_from_config + '<a id="ppol_anchor" name="privacy"></a>';
                                                ...
                                                $.ajax({
                                                   ...
                                                   url: getSettingsValue('kiosk.api.url') + "/login/qlogin2",
                                                    ...
                                                    success: function(html){
                                                        ...
                                                        HigiApiService.storeLoginUserRecord(html.User.id, 'password', function(res){
                                                        ...
                                                        // $rootScope.hPodRegistrationFlow = true;
