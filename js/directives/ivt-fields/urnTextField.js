angular
    .module("higiKioskUi")
    .directive("urnTextField", ['$rootScope', function($rootScope) {
        return {
            restrict : 'E',
            templateUrl : 'components/ivt_fields/urntextbox.html',
            scope : {
            mobilefield : "="
            },

            link : function (scope, element, attr) {
                console.log("inisde link()")
                ...
                scope.setIndex= function(id){
                    ...
                    console.log($rootScope.textFieldIndex);
                };
