angular
    .module("higiKioskUi")
    .directive("telemediMobileTextField", ['$rootScope', function($rootScope) {
        return {
            restrict : 'E',
            templateUrl : 'components/tele_medi_fields/tele_medi_mobiletextbox.html',
            scope : {
            mobilefield : "="
            },
            ...
            link : function (scope, element, attr) {
                ...
                scope.mobvalidmessage = "global.payment.mobvalidmessage";
